  ...
  return (
    ...
    <div className="Apps">
      ...
      <ul class="navbar-nav">
        ...
        {/* <a href="/Login" target="signUp" rel="ref">
      ...
      <div ref={services}className='services'>
               <h4>SERVICES</h4>
                <div className='cards'>
                    ...
                    <Popup trigger={<button className='btnss'>View</button>} position="centre">
